...
class AppInfo {
  ...
  Future<void> _setDeviceId() async {
    try {
      ...
      if (Platform.isIOS) {
        ...
        deviceSerial = iosDeviceInfo.identifierForVendor!;
      } else {
        final androidDeviceInfo = await deviceInfo.androidInfo;
        deviceId = androidDeviceInfo.id;
        deviceSerial = androidDeviceInfo.serialNumber;
  ...
  Map<String, dynamic> get appInfoToJson => {
        'version': AppInfo.instance.version,
        'device_id': AppInfo.instance.deviceId,
        'build_number': AppInfo.instance.buildNumber,
        'device_brand_model': AppInfo.instance.deviceBrandAndModel,
        'device_serial': AppInfo.instance.deviceSerial,
      };
}
