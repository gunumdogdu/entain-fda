...
class AppStateController {
  ...
  void setTheme({AbstractColor? colorPalette, bool skipSave = false}) {
    if (!skipSave) {
      _localeManager.setStringValue(
        key: themeCacheKey,
        value: colorPalette?.themeCode ?? getCurrentThemeCode!,
      );
    }
    _model.add(
      model.copyWith(
        themeData: colorPalette ?? getColorDataByCode(getCurrentThemeCode!),
