...
abstract class $UserModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, int created, String? about, List<int> submitted, int karma});
}
...
class _$UserModelImpl implements _UserModel {
  const _$UserModelImpl(
      ...
      this.about,
      final List<int> submitted = const [],
      this.karma = 0})
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, created: $created, about: $about, submitted: $submitted, karma: $karma)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, created, about,
      const DeepCollectionEquality().hash(_submitted), karma);
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      final int karma}) = _$UserModelImpl;
